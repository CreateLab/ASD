...
public static class ImageHelper
{
    const string errorMessage = "Could not recognize image format.";
        ...
        public static bool TryGetDimensions(string base64string, out Size dimensions)
        {
            try
            {
                dimensions = GetDimensions(base64string);
                return true;
            }
        ...
        public static Size GetDimensions(string base64string)
        {
            ...
            catch (ArgumentException e)
            {
                ...
                {
                    throw new ArgumentException(errorMessage, "base64string", e);
                }
                else
                {
                    throw e;
